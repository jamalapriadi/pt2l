...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel-title">Data Pelanggaran</div>
        </div>

        <div class="panel-body">
            <a href="#" class="btn btn-primary" id="tambah">
                <i class="icon-add"></i> Add New Pelanggaran
            </a>
                    ...
                    '<div class="modal-dialog" role="document">'+
                        ...
                        '<div class="modal-content">'+
                            '<div class="modal-header">'+
                                ...
                                '<h4 class="modal-title" id="myModalLabel">Add New Pelanggaran</h4>'+
                            '</div>'+
                                    ...
                                    '<div class="modal-body">'+
                                        '<div id="pesan"></div>'+
                                            '<div class="form-group">'+
                                                '<label class="col-lg-3 control-label">Nama</label>'+
                                                '<div class="col-lg-8">'+
                                                    '<input type="hidden" class="form-control" id="kode" name="kode" value="'+result.id+'" placeholder="Isi Nama" required readonly>'+
                                                    '<input type="text" class="form-control" id="nama" name="nama" value="'+result.nama+'" placeholder="Isi Nama" required>'+
                                                '</div>'+
                                            '</div>'+
